...
function Home(){
    return (
        <>
            ...
            <section className={styles["section__container"]}>
                <h2>🌠 A Universe of Possiblities Awaits</h2>
                <p> Immerse yourself in the thrill of exploration as you chart interplanetary courses within our solar system. Seamlessly navigate your fleet of spacecraft, hurtling through the cosmic void from one celestial body to another. The unvirse becomes your playground, and every planet a potential new home.</p>
            </section>
        </>
    );
}
